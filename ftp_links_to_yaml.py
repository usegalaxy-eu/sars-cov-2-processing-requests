    ...
    while upload_attempts > 0:
        for link in ena_links:
            if ena_links_states[link] in NON_OK_TERMINAL_STATES:
                ena_links_dataset_ids[link] = gi.tools.put_url(content=link, history_id=history_id)['outputs'][0]['id']
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'links_file',
        help='File containing list of links'
    )
    parser.add_argument(
        'collection_name',
